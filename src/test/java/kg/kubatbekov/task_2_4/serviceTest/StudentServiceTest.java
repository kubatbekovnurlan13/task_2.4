...
import kg.kubatbekov.task_2_4.service.StudentService;
...
public class StudentServiceTest extends PostgresContainer {
    ...
    void save_testSave_whenInputNull() {
        ...
        assertEquals("Cannot invoke \"kg.kubatbekov.task_2_4.model.Student.getFirst_name()\" because \"student\" is null", exception.getMessage());
    }
