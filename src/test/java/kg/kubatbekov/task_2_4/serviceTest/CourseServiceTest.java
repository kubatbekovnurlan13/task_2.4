package kg.kubatbekov.task_2_4.serviceTest;

import kg.kubatbekov.task_2_4.container.PostgresContainer;
import kg.kubatbekov.task_2_4.model.Course;
import kg.kubatbekov.task_2_4.service.CourseService;
import kg.kubatbekov.task_2_4.service.ValueInput;
...
class CourseServiceTest extends PostgresContainer {
    ...
    void save_testSave_whenNullInput() {
        ...
        Assertions.assertEquals("Cannot invoke \"kg.kubatbekov.task_2_4.model.Course.getCourse_name()\" because \"course\" is null", exception.getMessage());
    }
