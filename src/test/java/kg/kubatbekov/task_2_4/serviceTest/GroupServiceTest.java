...
import kg.kubatbekov.task_2_4.service.GroupService;
...
public class GroupServiceTest extends PostgresContainer {
    ...
    void save_testSave_whenInputNull() {
        ...
        Assertions.assertEquals("Cannot invoke \"kg.kubatbekov.task_2_4.model.Group.getGroup_name()\" because \"group\" is null", exception.getMessage());
    }
